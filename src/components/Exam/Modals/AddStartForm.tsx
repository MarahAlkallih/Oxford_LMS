...
import { useAddStartFormMutation } from "../../../services/exams/forms/startFormMutation";
import { toast } from "react-toastify";
import { CheckBox } from "../../Fields/CheackBox";
interface AddStartFormModalProps {
    open: boolean;
    onClose: () => void;
}

export const AddStartFormModal = ({ open, onClose }: AddStartFormModalProps) => {
...
const [createForm,{isLoading,isSuccess}]=useAddStartFormMutation()
