...
import { useActiveTrainerMutation } from "../../../services/trainer/createTrainer";
...
export const ActiveTrainerModal = ({ open, onClose, id,userName }: ActiveModalProps) => {
const [active,{isLoading}]=useActiveTrainerMutation()
