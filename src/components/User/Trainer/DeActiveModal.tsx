import { useDeActiveTrainerMutation } from "../../../services/trainer/createTrainer";
...
export const DeActiveTrainerModal = ({ open, onClose, id,userName }: DeActiveModalProps) => {
const [deactive,{isLoading}]=useDeActiveTrainerMutation()
